> ##### *Public Note Regarding Legal Interest: I am an advocate for internal institutional resolution. Having already ruled out litigation, issues of such magnitude, i.e. aspiration, require the commitment for constructive engagement; not the cynicism of resignation to conflict. My research is made available for the purpose of structural correction, with first right of response to the institution and then, subsequently, as due diligence to the concerned. Having ruled out litigation, all civil and legal claims, I will also rule out regulatory submission, given that it is a tool of delegated compulsion that is structurally a Liability Consequentialism pathway*
...
\
² ![Consumer, Primary](https://github.com/Aarception/Mo-information-security-portfolio/blob/main/trust-infrastructure/The_Mechanical_Impossibility_Finding.PDF)
\
