Update: Wednesday's review has confirmed the requirements of mail transmission of Board letter. The question that will have to be resolved: this matter has already taken longer than usual on account of process particularities. It would have been completed and closed on May 5th, at the end of the 20-day observation, during the opportunity pipeline, having passed the Google Hiring Assessment, while perfectly excited about the possibility of a successful career with the institution, all of which was sacrificed for the principle: my opportunity prospect is disparate to the issue's resolution as a structural matter, and could not be abandoned.
