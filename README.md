...
##### ⁴ A direct evidence for this proposition, which, by being shared now rather than having been leveraged during engagement, is confirmation of integrity rather than strategy, is the interception of the Global Interview Support agent's loop-in of the then assigned recruiter on June the 2nd. Regardless of the circumstance, and my own then subjective inclinations derived from limited observation established in record concerning that circumstance, I recognized then, explicitly and implicitly, it would not do to 'adverserially' use procedure against neither the recruiter nor the institution. So, despite the fact and against personal interest, I intercepted the liability created by the loop-in with the deconstruction: it does not require recruiter input at this time. I was never an antigen, I am just capable. 
