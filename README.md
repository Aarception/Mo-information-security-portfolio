...
##### ⁹ This is demonstrated by every channel that was not utilized, every acknowledgment that was not made, every offer that went unrecognized, and every allocation made in response to the compliance need created by the identification of the structural matter, while structurally erasing the identity of its source. It is not clear what evidence-based determination exists to justify the observed strategy possibly other than any response divorced from liability processing may also be structurally non-existent.
