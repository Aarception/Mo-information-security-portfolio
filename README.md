...
Is that how you would like me to act? Play loose with my principles and better character? I mean let's pause rationally here. Suppose I am unpalatable, because I am the one who discovered the "issue"—well, I have not applied since Final Communication, have I? Alright, so you get that, then what is the resolution because I see no movement on anything. You are not moving on the issue, nor are you specifically responding to to my own reasonable request for redress. The fact that I have been forced to implicate the May 13 observation is a very clear siren about how quickly this can deteriorate fast. 

You have had months of opportunity to observe my operation. I don't produce sloppy work. I do not even produce commensurate. I produce Consilience Engineering. I produce 10 layers of recursive Iteration. If this escalates, it will not be about motive. It will be about responsibility, rights, duty, obligation, commitment; it will not be about a product, it will be about equitable workforce, public policy, civil rights,  algorithmic disparate impact. It will be about the fact the majority of injury disproportionately affect the least of these.
...
1. The response to the inquiry is now just as important as the original inquiry
2. The ESG frame is entirely about individual decision-making
